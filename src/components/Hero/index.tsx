...
const Hero = ({
  ...
  return (
            <Grid container spacing={5} sx={{backgroundColor: "#fff", padding: 3, borderRadius: 4}}>
              <Grid size={6}>
                <Image
              ...
              <Grid size={6} sx={{display: "flex", flexDirection: "column", justifyContent: "space-between"}}>
                ...
                <Box sx={{height: "100%"}}>
                    ...
                    <Typography component="p" mt={1} color='secondary' sx={{height: "100%", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1}}>
                ...
                <Button variant="contained" sx={{ mt: 2, bgcolor: '#F5A623', borderRadius: 6, textTransform: "unset" }}>
                  Mais informações
                </Button>
              </Grid>
            </Grid>
